/**
 * INA228-Q1 – Advanced demo: temperature + energy/charge + multi-threshold alert.
 *
 * =========================================================================
 ...
 * The INA228-Q1 has an integrated die temperature sensor (±1 °C accuracy)
...
static InaBridge228      sensor("INA228-Q1", 0x40, "TI INA228-Q1");
...
void setup() {
  ...
  Serial.print(F("{\"v\":1,\"type\":\"ALERT_CFG\",\"chip\":\"INA228-Q1\",\"addr\":\"0x40\""));
...
void loop() {
  ...
  if (alertTriggered) {
    ...
    Serial.print(F("{\"v\":1,\"type\":\"ALERT_EVENT\",\"chip\":\"INA228-Q1\",\"addr\":\"0x40\""));
  ...
  if ((now - g_lastEnergyMs) >= ENERGY_REPORT_MS) {
    ...
    if (clsb > 0.0f) {
      ...
      Serial.print(F("{\"v\":1,\"type\":\"ENERGY\",\"chip\":\"INA228-Q1\",\"addr\":\"0x40\""));
