/**
 * INA740X – Advanced demo: temperature + energy/charge + multi-threshold alert.
 *
 * =========================================================================
 ...
 * The INA740X has an integrated die temperature sensor (±1 °C accuracy)
...
static InaBridge228      sensor("INA740X", 0x40, "TI INA740X");
...
void setup() {
  ...
  Serial.print(F("{\"v\":1,\"type\":\"ALERT_CFG\",\"chip\":\"INA740X\",\"addr\":\"0x40\""));
...
void loop() {
  ...
  if (alertTriggered) {
    ...
    Serial.print(F("{\"v\":1,\"type\":\"ALERT_EVENT\",\"chip\":\"INA740X\",\"addr\":\"0x40\""));
  ...
  if ((now - g_lastEnergyMs) >= ENERGY_REPORT_MS) {
    ...
    if (clsb > 0.0f) {
      ...
      Serial.print(F("{\"v\":1,\"type\":\"ENERGY\",\"chip\":\"INA740X\",\"addr\":\"0x40\""));
