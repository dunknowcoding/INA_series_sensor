/**
 * INA229 – ALERT interrupt demo (conversion ready, SPI).
 *
 * =========================================================================
 ...
 *   INA229 MISO   ->  GPIO 5
 *   INA229 MOSI   ->  GPIO 6
 *   INA229 ALERT  ->  GPIO 2  (open-drain, add 10 k pull-up to VCC)
 ...
 * =========================================================================
 * The INA229 shares the same DIAG_ALRT / BOVL / BUVL / SOVL / SUVL /
