/**
 * INA236 – ALERT interrupt demo (bus over-voltage).
 *
 * =========================================================================
...
static InaBridge226 sensor("INA236", 0x40, "TI SLYSF02 (INA236)");
...
void setup() {
  ...
  Serial.print(F("{\"v\":1,\"type\":\"ALERT_CFG\",\"chip\":\"INA236\",\"addr\":\"0x40\""));
...
void loop() {
  ...
  if (alertTriggered) {
    ...
    Serial.print(F("{\"v\":1,\"type\":\"ALERT_EVENT\",\"chip\":\"INA236\",\"addr\":\"0x40\""));
