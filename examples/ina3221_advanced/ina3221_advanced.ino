/**
 * INA3221 – Advanced demo: CRI + WAR + PV + shunt voltage summation.
 *
 * =========================================================================
 ...
 *
 * NOTE: The INA3221 does NOT have a temperature sensor or energy/charge
...
void loop() {
  ...
  if (pvNow != g_lastPvState) {
    g_lastPvState = pvNow;
    Serial.print(F("{\"v\":1,\"type\":\"PV_EVENT\",\"chip\":\"INA3221\",\"addr\":\"0x40\""));
