/**
 * INA220-Q1 – ALERT interrupt demo (bus over-voltage).
 *
 * =========================================================================
 * IMPORTANT – Module compatibility
 * =========================================================================
 * Most common INA220-Q1 breakout boards (Adafruit INA219 #904, GY-219, generic
...
static InaBridge219 sensor("INA220-Q1", 0x40);
...
void setup() {
  ...
  Serial.print(F("{\"v\":1,\"type\":\"ALERT_CFG\",\"chip\":\"INA220-Q1\",\"addr\":\"0x40\""));
...
void loop() {
  ...
  if (alertTriggered) {
    ...
    Serial.print(F("{\"v\":1,\"type\":\"ALERT_EVENT\",\"chip\":\"INA220-Q1\",\"addr\":\"0x40\""));
