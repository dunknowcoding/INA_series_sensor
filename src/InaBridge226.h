...
/**
 * @brief INA226-family sensor driver with optional JSONL serial streaming.
 *
...
public:
   ...
   * @note CVRF is bit 3 of the Mask/Enable register (0x06). Reading
   *       this register clears the flag, so calling dataReady() twice
